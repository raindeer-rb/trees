...
Current CLI frameworks are also vague. They let you build your beautiful structure... component by component, type by type. Then map user input to those components.

Trees just gets you to write what the literal user input will be, then breaks it down into a nested tree of commands, subcommands and options if need be. Think of your commands as routes with params. Think of the structure as a tree 🌲.
